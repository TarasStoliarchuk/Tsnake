...
class Snake:
    ...
    def draw(self):
        self.parent_screen.fill((100, 66, 255))
...
class Game:
    ...
    def show_game_over(self):
        ...
        line2 = font.render(f"To play again press Enter. To exit press Escape", True,
                            (255, 255, 255))
